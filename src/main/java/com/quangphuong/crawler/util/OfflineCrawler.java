...
//    private static int stopDate = 20090120;
    ...
    private static int stopDate = 20160411;
    private static int startY = 20140000;
    private static int startD = 16;
    private static int startM = 600;
...
//                            System.out.println("kindddddddddddddddd: " + kind);
                            ...
                            dBWrapper.insertEntity(highlight);
                        }
                    }
                }
//                System.out.println("-------------------");
//                System.out.println("Page memory: " + Agent.sizeOf(page));
                ...
                Logger.getLogger(OfflineCrawler.class.getName()).log(Level.SEVERE, null, ex);
            }
            if(goNext){
